  ...
  return (
    <main className='w-full'>
      ...
      <section className='h-[calc(100vh-4rem)] relative flex items-center'>
        <div className='flex flex-row-reverse flex-wrap gap-x-[15vw] w-full justify-center items-center p-16'>
          <Image className='w-[280px] sm:w-[400px]' src={BASE_PATH + "/avatar.png"} width={400} height={0} alt='/avatar.png' />
          <div>
            <p>Hello</p>
            <h1 className='text-4xl sm:text-6xl font-semibold'>I&apos;m Tze Young</h1>
        ...
        <div className='hidden sm:block absolute bottom-0 left-[50%] -translate-x-1/2'>
      ...
      <section className='w-full h-auto bg-gray-700'>
        <div className='max-w-[120ch] px-[5%] mx-auto'>
          ...
          <div className="flex flex-wrap w-full items-center justify-start gap-2 mx-auto my-4">
